...
public class ProjectMemberEntity {
  ...
  **/
   ...
   * @return entityId
  **/
  @ApiModelProperty(value = "the id of entity, if the member is an user, it is user_id in user table. if the member is an user group, it is the user group's ID in user_group table.")
