...
import org.kathra.harbor.client.model.InlineResponse2001;
...
import org.kathra.harbor.client.model.VulnerabilityItem;
...
public class ProductsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2001 chartrepoHealthGet() throws ApiException {
        ApiResponse<InlineResponse2001> resp = chartrepoHealthGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2001> chartrepoHealthGetWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call chartrepoHealthGetAsync(final ApiCallback<InlineResponse2001> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call usersSearchGetCall(String username, String email, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call usersSearchGetValidateBeforeCall(String username, String email, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = usersSearchGetCall(username, email, page, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<UserSearch> usersSearchGet(String username, String email, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<List<UserSearch>> resp = usersSearchGetWithHttpInfo(username, email, page, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<UserSearch>> usersSearchGetWithHttpInfo(String username, String email, Integer page, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = usersSearchGetValidateBeforeCall(username, email, page, pageSize, null, null);
        Type localVarReturnType = new TypeToken<List<UserSearch>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Search users by username, email (asynchronously)
     * This endpoint is to search the users by username, email. 
     * @param username Username for filtering results. (optional)
     * @param email Email for filtering results. (optional)
     * @param page The page nubmer, default is 1. (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call usersSearchGetAsync(String username, String email, Integer page, Integer pageSize, final ApiCallback<List<UserSearch>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = usersSearchGetValidateBeforeCall(username, email, page, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<UserSearch>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for usersUserIdGenCliSecretPost
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call usersUserIdGenCliSecretPostCall(Integer userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/users/{user_id}/gen_cli_secret"
            .replaceAll("\\{" + "user_id" + "\\}", apiClient.escapeString(userId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call usersUserIdGenCliSecretPostValidateBeforeCall(Integer userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling usersUserIdGenCliSecretPost(Async)");
        }
        

        com.squareup.okhttp.Call call = usersUserIdGenCliSecretPostCall(userId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse200 usersUserIdGenCliSecretPost(Integer userId) throws ApiException {
        ApiResponse<InlineResponse200> resp = usersUserIdGenCliSecretPostWithHttpInfo(userId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse200> usersUserIdGenCliSecretPostWithHttpInfo(Integer userId) throws ApiException {
        com.squareup.okhttp.Call call = usersUserIdGenCliSecretPostValidateBeforeCall(userId, null, null);
        Type localVarReturnType = new TypeToken<InlineResponse200>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Generate new CLI secret for a user. (asynchronously)
     * This endpoint let user generate a new CLI secret for himself.  This API only works when auth mode is set to &#39;OIDC&#39;. Once this API returns with successful status, the old secret will be invalid, as there will be only one CLI secret for a user.  The new secret will be returned in the response. 
     * @param userId User ID (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call usersUserIdGenCliSecretPostAsync(Integer userId, final ApiCallback<InlineResponse200> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = usersUserIdGenCliSecretPostValidateBeforeCall(userId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse200>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
